...
# val+=val       
    ...
    def test_question_post(self):
        ...
        response=self.client.post("/api/v1/questions", data=json.dumps(self.q1), content_type=("application/json"))
    ...
    def test_question_patch_upvote(self):
        ...
        response_1=self.client.post("/api/v1/questions", data=json.dumps(self.q1))
    ...
    def test_question_patch_downvote(self):
            ...
            response=self.client.post("/api/v1/questions", data=json.dumps(self.q1))
            results=json.loads(response.data.decode("utf-8"))
            results_id=results["id"]
            self.assertEqual(results.status_code, 201)

            response=self.client.patch("/api/v1/questions/{}/downvote".format(results_id))
